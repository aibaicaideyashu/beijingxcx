            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'avatar', title: '缩略图',  operate:false,formatter: Table.api.formatter.images},
                        {field: 'spec_type', title: __('Spec_type'), searchList: {"10":__('Spec_type 10'),"20":__('Spec_type 20')}, formatter: Table.api.formatter.normal},
                        {field: 'attr_type', title: '商品类型', searchList: {"1":'团购',"2":'秒杀',"3":'积分'}, formatter: Table.api.formatter.normal},
                        {field: 'sales_actual', title: __('Sales_actual')},
                        {field: 'goods_sort', title: __('Goods_sort')},
                        {field: 'goods_status', title: __('Goods_status'), searchList: {"1":__('Goods_status 10'),"0":__('Goods_status 20')}, formatter: Table.api.formatter.toggle, pk: 'goods_id'},
